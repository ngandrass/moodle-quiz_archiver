...
course can be included. Generated PDFs can be converted into a PDF/A-3b
compliant format for long-term storage. A checksum is calculated for every file
within the archive, as well as the archive itself, to allow verification of file
integrity. Archives can optionally be cryptographically signed by a trusted
