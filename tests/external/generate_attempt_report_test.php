...
final class generate_attempt_report_test extends \advanced_testcase {
     ...
     */
    protected function generate_valid_request(string $jobid, int $courseid, int $cmid, int $quizid, int $attemptid): array {
        return [
            'jobid' => $jobid,
            'courseid' => $courseid,
            'cmid' => $cmid,
    ...
    public function test_capability_requirement(): void {
        ...
        $r = $this->generate_valid_request($job->get_jobid(), $mocks->course->id, $mocks->quiz->cmid, $mocks->quiz->id, 1);
    ...
    public function test_execute(): void {
        ...
        $r = $this->generate_valid_request($jobid, $mocks->course->id, $mocks->quiz->cmid, $mocks->quiz->id, 1);
    ...
    public function test_invalid_job(): void {
        $r = $this->generate_valid_request('00000000-0000-0000-0000-000000000000', 1, 1, 1, 1);
