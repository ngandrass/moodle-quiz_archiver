...
$string['export_attempts_image_resize'] = 'Bilder optimieren';
$string['export_attempts_image_resize_help'] = 'Wenn aktiviert, werden große Bilder innerhalb der Versuchsberichte unter Berücksichtigung der unten angegebenen Dimensionen verkleinert. Bilder werden ausschließlich verkleinert. Bilder, die kleiner als die angegebenen Dimensionen sind, bleiben unberührt. Dies betrifft nur PDF-Exporte. HTML-Quelldateien behalten stets die Originalbildgröße bei.';
$string['export_attempts_image_resize_group'] = 'Maximale Bildauflösung';
$string['export_attempts_image_resize_group_help'] = 'Maximale Auflösung für Bilder innerhalb der Versuchsberichte in Pixeln (Breite x Höhe). Wenn ein Bild breiter oder höher als die angegebenen Dimensionen ist, wird es so verkleinert, dass es vollständig in die angegebenen Dimensionen passt. Das Seitenverhältnis wird dabei beibehalten. Dies kann nützlich sein, um die Gesamtgröße des Archivs zu reduzieren, wenn große Bilder im Test verwendet werden.';
$string['export_attempts_image_resize_height'] = 'Maximale Bildhöhe';
$string['export_attempts_image_resize_height_help'] = 'Maximale Höhe für Bilder innerhalb der Versuchsberichte in Pixeln. Wenn ein Bild höher als die angegebene Höhe ist, wird es auf die angegebene Höhe verkleinert, wobei das Seitenverhältnis beibehalten wird.';
$string['export_attempts_image_resize_width'] = 'Maximale Bildbreite';
$string['export_attempts_image_resize_width_help'] = 'Maximale Breite für Bilder innerhalb der Versuchsberichte in Pixeln. Wenn ein Bild breiter als die angegebene Breite ist, wird es auf die angegebene Breite verkleinert, wobei das Seitenverhältnis beibehalten wird.';
