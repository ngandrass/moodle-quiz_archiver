...
$string['error_no_attempts_left_after_filtering'] = 'Nach Anwendung der ausgewählten Filter sind keine Testversuche zum Exportieren übrig geblieben.';
...
$string['export_report_section_header'] = 'Testkopf einschließen';
$string['export_report_section_header_help'] = 'Informationen des Versuchs (z.B. Teilnehmender, Startzeitpunkt, Endzeitpunkt, Bewertung, ...) im Kopf des Berichts einschließen';
...
$string['export_report_section_quiz_grade'] = 'Testbewertung einschließen';
$string['export_report_section_quiz_grade_help'] = 'Zeigt die Bewertung des gesamten Testversuchs im Kopfbereich des Versuchsberichts an.';
...
$string['export_report_section_question_correctness'] = 'Korrektheit der Antworten einschließen';
$string['export_report_section_question_correctness_help'] = 'Zeigt im Versuchsbericht an, ob eine Frage richtig oder falsch beantwortet wurde.';
...
$string['export_report_section_question_marks'] = 'Fragenpunkte einschließen';
$string['export_report_section_question_marks_help'] = 'Zeigt die erhaltenen Punkte für jede Frage im Versuchsbericht an.';
...
$string['export_report_section_question_internals'] = 'Interne Fragenmetadaten einschließen';
$string['export_report_section_question_internals_help'] = 'Zeigt interne Fragenmetadaten (Fragen-ID, ID-Nummer, Tags und Version der Frage) oberhalb jeder Frage im Versuchsbericht an.';
$string['export_attempts_filter'] = 'Filter';
$string['export_attempts_filter_latest'] = 'Nur neuste Testversuche exportieren';
$string['export_attempts_filter_latest_help'] = 'Wenn diese Option aktiviert ist werden ausschließlich die letzten Testversuche je Nutzer exportiert. Ältere Testversuche werden automatisch ignoriert.';
...
$string['export_flat_archive'] = 'Flache Archivstruktur';
$string['export_flat_archive_help'] = 'Wenn diese Option aktiviert ist, wird innerhalb des exportierten Archivs auf Unterordner verzichtet. Alle Dateien werden stattdessen im Stammverzeichnis des generierten Archivs abgelegt. Bitte achten Sie darauf einen <b>eindeutigen Versuchsnamen</b> zu wählen!';
