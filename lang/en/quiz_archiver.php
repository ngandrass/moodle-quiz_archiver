...
$string['export_attempts_filter_latest'] = 'Only latest';
$string['export_attempts_filter_latest_help'] = 'Filters to include only the most recent attempt by each student.';
...
$string['export_flat_archive'] = 'Flatten export archive';
$string['export_flat_archive_help'] = 'Will omit any directory structure inside the exported archive.';
