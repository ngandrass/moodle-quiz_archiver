...
$string['export_attempts_image_resize'] = 'Optimize images';
$string['export_attempts_image_resize_help'] = 'If enabled, large images inside the quiz attempt reports will be shrunk with respect to the following dimensions. Images will only be scaled down. Images smaller than the given dimensions remain untouched. This only affects PDF exports. HTML source files will always keep the original image size.';
$string['export_attempts_image_resize_group'] = 'Maximum image dimensions';
$string['export_attempts_image_resize_group_help'] = 'Maximum dimensions for images inside the quiz attempt reports in pixels (width x height). If an image is larger than the given width or height, it will be scaled down so that it fully fits into the given dimensions while maintaining its aspect ratio. This can be useful to reduce the overall archive size if large images are used within the quiz.';
$string['export_attempts_image_resize_height'] = 'Maximum image height';
$string['export_attempts_image_resize_height_help'] = 'Maximum height of images inside the quiz attempt reports in pixels. If an images height is larger than the given height, it will be scaled down to the given height while maintaining its aspect ratio.';
$string['export_attempts_image_resize_width'] = 'Maximum image width';
$string['export_attempts_image_resize_width_help'] = 'Maximum width of images inside the quiz attempt reports in pixels. If an images width is larger than the given width, it will be scaled down to the given width while maintaining its aspect ratio.';
