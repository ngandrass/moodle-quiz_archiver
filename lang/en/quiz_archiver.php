...
$string['export_report_section_quiz_grade'] = 'Include quiz grade';
$string['export_report_section_quiz_grade_help'] = 'Displays the overall quiz grade inside the attempt report header.';
...
$string['export_report_section_question_correctness'] = 'Include question correctness';
$string['export_report_section_question_correctness_help'] = 'Shows whether a question was answered correctly or not inside the attempt report.';
...
$string['export_report_section_question_marks'] = 'Include question marks';
$string['export_report_section_question_marks_help'] = 'Shows the raw marks received for each question inside the attempt report.';
...
$string['export_report_section_question_internals'] = 'Include question internals';
$string['export_report_section_question_internals_help'] = 'Shows internal question metadata (question ID, ID number, tags, and question version) above each question inside the attempt report.';
$string['export_attempts_filter'] = 'Filters';
$string['export_attempts_filter_latest'] = 'Export only latest attempts';
$string['export_attempts_filter_latest_help'] = 'If selected, only the most recent attempt will be exported for each user. Older attempts will automatically be omitted.';
...
$string['export_flat_archive'] = 'Flatten archive';
$string['export_flat_archive_help'] = 'If enabled, all directories inside the exported archive will be omitted. All files will be placed in the root directory of the generated archive. Please make sure to <b>choose a unique attempt filename!</b>';
...
$string['export_attempts_filename_pattern_variable_groupids'] = 'Group IDs';
$string['export_attempts_filename_pattern_variable_groupidnumbers'] = 'Group ID numbers';
$string['export_attempts_filename_pattern_variable_groupnames'] = 'Group names';
